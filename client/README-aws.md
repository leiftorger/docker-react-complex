...
Add AWS configuration details to github action-script
...
Copy and/or download the Access Key ID and Secret Access Key to use in the github action-script: add them to github-repo action-secrets
...
Go to your github action on github-repo and check the status of your build.
